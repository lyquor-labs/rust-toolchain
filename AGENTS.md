...
This repo is a minimal wrapper around a GitHub Actions workflow that builds `rust-std` for `wasm32-unknown-unknown` from `rust-lang/rust` tag `1.97.1` and uploads artifacts from `rust/build/dist`.
